...
run = do
  ...
  case (day, part) of
    ...
    (19, 1) -> return (Right (Day19.part1 input))
    (19, 2) -> return (Right (Day19.part2 input))
    (20, 1) -> return (Right (Day20.part1 $ lines input))
    (20, 2) -> return (Right (Day20.part2 $ lines input))
    (21, 1) -> return (Right (Day21.part1 $ lines input))
    (21, 2) -> return (Right (Day21.part2 $ lines input))
    (22, 1) -> return (Right (Day22.part1 $ lines input))
    (22, 2) -> return (Right (Day22.part2 $ lines input))
    (23, 1) -> return (Right (Day23.part1 $ lines input))
    (23, 2) -> return (Right (Day23.part2 $ lines input))
    (24, 1) -> return (Right (Day24.part1 input))
    (24, 2) -> return (Right (Day24.part2 input))
    (25, 1) -> return (Right (Day25.part1 input))
